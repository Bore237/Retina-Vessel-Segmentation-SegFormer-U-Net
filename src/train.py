...
def train_segformer(config_dataset, training_args, metrics=None, compute_metrics=None, compute_loss=None, transforms=None):
    ...
    metric = metrics if metrics else None
